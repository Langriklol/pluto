...
#ifndef __PLUTO__DRIVERS__AMD_AM79C973_H
#define __PLUTO__DRIVERS__AMD_AM79C973_H
...
namespace pluto
{
    namespace drivers
    {
        ...
        public:
            amd_am79c973(pluto::hardwarecommunication::PeripheralComponentInterconnectDeviceDescriptor *dev,
                         pluto::hardwarecommunication::InterruptManager* interrupts);
            ~amd_am79c973();
